...
import kotlinx.android.synthetic.main.activity_ref.addRef
import kotlinx.android.synthetic.main.activity_ref2.*

class RefActivity2 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ref2)

        addRef2.setOnClickListener {
            material_modal("", "", "", "", 0)
        }
    }
